...
MR_INIT_DEVICES := device/lge/geeb/mr_init_devices.c
MR_RD_ADDR := 0x82000000
MR_DPI := hdpi
MR_DPI_FONT := 216
MR_FSTAB := device/lge/geeb/twrp.fstab
MR_KEXEC_MEM_MIN := 0x84000000
MR_INFOS := device/lge/geeb/mrom_infos
MR_DEVICE_RECOVERY_HOOKS := device/lge/geeb/mr_hooks_recovery.c
